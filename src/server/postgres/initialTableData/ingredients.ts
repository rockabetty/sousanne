      ...
      */
      ...
      "produce": { 
         ...
         "vegetables" : {
            ...
            "brassicaceae": {
               ...
               "brassica": { 
                  "Cabbage": { "variants": ["Green Cabbage", "Red Cabbage", "Napa Cabbage"]},
               },
            },
            "zingiberaceae": {
               "zingiber": {
            ...
            "solanaceae": { 
               "capsicum": { 
                  "Sweet Pepper": { "variants": ["Green Bell Pepper", "Yellow Bell Pepper", "Red Bell Pepper", "Orange Bell Pepper"]},
                  "Hot Pepper": { 
            ...
            "fabaceae": {
               "vicia": {
                  ...
                  "Firm Lentils": { variants: ["Black Lentils", "Brown Lentils", "French Lentils", "Green Lentils", "Puy Lentils"]},
                  "Petite Lentils" {
                     variants: [
                       "Crimson Lentils",
                       "Golden Lentils",
               ...
               "phaseolus": {
                  "Beans": {
                     variants: [
                       ...
                       "Black Turtle Beans",
                       "Bolita Beans",
                       { name: "Calypso Beans", alii: ["Panda Beans", "Yin Yang Beans"] }
                       "Cranberry Beans",
                       "Dragon Tongue Beans",
                       "Flageolet Beans",
                       ...
                       "Yellow Beans": {
                        variants: ["Sinaloa Azufraddo Beans", "Mayacoba Beans", "Peruano Beans"]
                       }
      ...
      "fats_and_oils": {
         "cooking_fats": {
            ...
            "medium_smoke_point":{ "variants":  ["Lard", "Schmaltz", "Duck Fat", "Peanut Oil", "Beef Tallow", "Vegetable Shortening"]},
            "high_smoke_point": { "variants":["Safflower Oil", "Grapeseed Oil", "Ghee"]},
         },
         "dressing_oils": { 
            "nut_oils": { "variants": ["Walnut Oil", "Hazelnut Oil", "Macadamia Oil"]},
            "seed_oils": { "variants":  ["Flaxseed Oil", "Pumpkin Seed Oil", "Hemp Seed Oil"]},
            "infused_oils": { 
      ...
      "sauces_and_condiments": {
          "vinegars": { 
            "mild_and_sweet": {"variants": ["Rice Vinegar", "White Balsamic Vinegar", "Champagne Vinegar", "Coconut Vinegar"]},
            "rich_and_sweet": {"variants":["Balsamic Vinegar", "Aged Balsamic", "Mirin", "Sherry Vinegar"]},
            "bright_and_fruity": {"variants": ["Apple Cider Vinegar", "White Wine Vinegar", "Red Wine Vinegar"]},
            "strong_and_pungent": {"variants": ["Distilled White Vinegar", "Malt Vinegar", "Spirit Vinegar"]},
            "umami_bomb": {"variants": ["Chinese Black Vinegar"]},
         },
         "sauces": { 
            "hot_sauces": { 
               "vinegar_forward":  {"variants": ["Tabasco", "Crystal", "Frank's RedHot", "Louisiana Hot Sauce"]},
               "chile_forward":  {"variants": ["Cholula", "Valentina", "Tapatio", "Texas Pete"]},
               "fruity_and_tropical":  {"variants": ["Sriracha", "Gochujang", "Sweet Chili Sauce", "Mango Habanero Sauce"]},
               "smoky_and_complex":  {"variants": ["Chipotle Hot Sauce", "Adobo Sauce", "Harissa"]},
               "extra_hot":  {"variants": ["Ghost Pepper Sauce", "Carolina Reaper Sauce", "Habanero Sauce"]},
