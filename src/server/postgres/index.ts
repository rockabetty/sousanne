...
/**
 * Builds a string representation of one-to-many relationships
 * suitable for SQL insertion. It's not intended for use with
 * queries that have not been parameterized, that'd be wild.
 *
...
export function getOneRowResult<T extends QueryResultRow>(
